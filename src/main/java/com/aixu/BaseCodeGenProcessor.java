...
import com.aixu.dao.DaoCodeGenProcessor;
import com.aixu.dao.GenDAO;
import com.aixu.entity.GenJPAEntity;
import com.aixu.service.GenService;
import com.aixu.service.GenServiceImpl;
import com.aixu.service.GenServiceProcessor;
import com.aixu.vo.VoCodeGenVoProcessor;
...
//    String serviceName = GenServiceProcessor.SERVICE_SUFFIX + typeElement.getSimpleName()
//        + GenServiceProcessor.SERVICE_SUFFIX;
    String serviceName = typeElement.getSimpleName() + GenServiceProcessor.SERVICE_SUFFIX;
//    String implName = typeElement.getSimpleName() + GenServiceImplProcessor.IMPL_SUFFIX;
    String repositoryName = typeElement.getSimpleName() + DaoCodeGenProcessor.SUFFIX;
//    String mapperName = typeElement.getSimpleName() + GenMapperProcessor.SUFFIX;
    String voName = typeElement.getSimpleName() + VoCodeGenVoProcessor.SUFFIX;

    String jpaEntityClassName  = typeElement.getSimpleName().toString();
...
//    String controllerName = typeElement.getSimpleName() + GenControllerProcessor.CONTROLLER_SUFFIX;
    ...
    context.setJpaEntityClassName(jpaEntityClassName);
...
//    });
    ...
    Optional.ofNullable(typeElement.getAnnotation(GenJPAEntity.class)).ifPresent(anno -> {
      context.setJpaEntityPackageName(anno.pkgName());
    });
